...
#define L3GD20_SPI_SCK_GPIO_CLK          __HAL_RCC_GPIOA_CLK_ENABLE
...
#define L3GD20_SPI_MISO_GPIO_CLK         __HAL_RCC_GPIOA_CLK_ENABLE
...
#define L3GD20_SPI_MOSI_GPIO_CLK         __HAL_RCC_GPIOA_CLK_ENABLE
...
#define L3GD20_SPI_CS_GPIO_CLK           __HAL_RCC_GPIOE_CLK_ENABLE

#define L3GD20_SPI_INT1_PIN              GPIO_PIN_0                  /* PE.00 */
#define L3GD20_SPI_INT1_GPIO_PORT        GPIOE                       /* GPIOE */
#define L3GD20_SPI_INT1_GPIO_CLK         __HAL_RCC_GPIOE_CLK_ENABLE
...
#define L3GD20_SPI_INT2_GPIO_CLK         __HAL_RCC_GPIOE_CLK_ENABLE
...
#define L3GD20_CS_LOW()       LL_GPIO_ResetOutputPin(L3GD20_SPI_CS_GPIO_PORT, L3GD20_SPI_CS_PIN)
#define L3GD20_CS_HIGH()      LL_GPIO_SetOutputPin(L3GD20_SPI_CS_GPIO_PORT, L3GD20_SPI_CS_PIN)
/**
  * @}
  */
